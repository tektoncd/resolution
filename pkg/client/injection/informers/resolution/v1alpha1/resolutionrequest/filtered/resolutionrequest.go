...
import (
	...
	filtered "github.com/tektoncd/resolution/pkg/client/injection/informers/factory/filtered"
...
func Get(ctx context.Context, selector string) v1alpha1.ResolutionRequestInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/tektoncd/resolution/pkg/client/informers/externalversions/resolution/v1alpha1.ResolutionRequestInformer with selector %s from context.", selector)
	}
